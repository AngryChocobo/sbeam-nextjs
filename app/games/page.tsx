...
export default function Home() {
  return (
    <main className="flex-1 bg-[url('/imgs/home-bg.png')]  ">
      <section className="flex  flex-col items-center justify-between max-w-screen-xl m-auto py-8 ">
          ...
          <div className="mt-6 grid grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-4">
            {games.map((product) => (
              <div key={product.sid} className="group relative">
                <div className="shadow-xl aspect-h-1 aspect-w-1 w-full overflow-hidden  bg-gray-200 lg:aspect-none group-hover:opacity-75">
                  <img
                    src={product.image}
                    alt={product.name}
                ...
                <div className=" flex justify-between">
                  ...
                  <p className="text-lg bg-black font-medium text-white pr-2">
                    <span className="mr-4  bg-green-500 h-full inline-block px-2 text-black font-bold">
                      -{product.discount ?? 50}%
                    </span>
                    <span className="mr-4 line-through text-gray-400">
                      ${product.full_price}
                    </span>
